...
public class ConcurrentSieveAlgorithmTest {

    @InjectMocks
    private ConcurrentSieveAlgorithm concurrentSieveAlgorithm;


    @Test
    public void testZeroAndOneReturnsEmpty() {
        ArrayList<Integer> responseZero = concurrentSieveAlgorithm.getPrimeNumberArrayList(0);
        assertTrue(responseZero.isEmpty());

        ArrayList<Integer> responseOne = concurrentSieveAlgorithm.getPrimeNumberArrayList(1);
        assertTrue(responseOne.isEmpty());
    }

    @Test
    public void testInputTwoReturnsTwo() {
        ArrayList<Integer> result = concurrentSieveAlgorithm.getPrimeNumberArrayList(2);
    ...
    public void testSmallInputReturnsCorrectPrimes() throws IOException {
        ...
        ArrayList<Integer> result = concurrentSieveAlgorithm.getPrimeNumberArrayList(smallInput);
    ...
    public void testLargeInputReturnsCorrectPrimes() throws IOException {
        ...
        ArrayList<Integer> result = concurrentSieveAlgorithm.getPrimeNumberArrayList(largeInput);
